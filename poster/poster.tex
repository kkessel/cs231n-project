...
\begin{figure}%
    \centering
    \subfloat[Colorized MNIST training set for classification of hand-written digits]{{\includegraphics[width=.2\textwidth]{img/mnist_color.png}}}%
    \qquad
    \subfloat[Blue concept training set and non-blue training set to learn CAVs for concept blue]{\includegraphics[width=.2\textwidth]{img/cav_viz}}}%
    \qquad
    \subfloat[blah blah]{\includegraphics[width=.2\textwidth]{img/blue2s}}\
%    \caption{2 Figures side by side}%
    \label{fig:example}%
\end{figure}
...
\begin{figure}%
    \centering
    \subfloat[Accuracy of model trained on color-balanced data set and tested on color-biased data sets (rows)]{{\includegraphics[width=.4\textwidth, backgroundcolor=white]{img/data_distr_balanced_test_new2} }}%
    \qquad
...
\begin{figure}%
    \centering
    \subfloat[TCAV scores for testing the concept blue for class 2]{{\includegraphics[width=.4\textwidth]{img/table1} }}%
    \qquad
