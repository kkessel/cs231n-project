...
\begin{figure}%
    \centering
    \subfloat[Colorized MNIST training set for classification of hand-written digits]{{\includegraphics[width=.4\textwidth]{img/mnist_color.png}}}%
    \qquad
    \subfloat[Blue concept training set and non-blue training set to learn CAVs for concept blue]{\includegraphics[width=width=.4\textwidth]{img/cav_viz}}}%
%    \caption{2 Figures side by side}%
    \label{fig:example}%
\end{figure}
