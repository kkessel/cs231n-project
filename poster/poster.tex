...
\begin{figure}%
    \centering
    \subfloat[label 1]{{\includegraphics[width=5c m]{img/data_distr_balanced_test_new.pdf} }}%
    \qquad
    \subfloat[label 2]{{\includegraphics[width=5cm]{img/data_distr_blue2_test_new.pdf} }}%
    \caption{2 Figures side by side}%
    \label{fig:example}%
\end{figure}
